...
{
    public class LoadRemoverComponent : IComponent
    {
        ...
        public LoadRemoverSettings Settings { get; set; }
        ...
        public bool LoadKeyIsPressed = false;
        ...
        {
            Settings = new LoadRemoverSettings();
            InternalComponent = new InfoTextComponent("Loading", "No");
        ...
        public void Update(IInvalidator invalidator, LiveSplitState state, float width, float height, LayoutMode mode)
        {
            ...
            //InternalComponent.InformationValue = IsLoading ? "Yes" : "No";
